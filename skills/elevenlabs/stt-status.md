...
Show daemon status plus hotkey/API/output readiness.

## Instructions

When the user runs `/elevenlabs-stt:status`:
...
Config path: /Users/you/.claude/plugins/elevenlabs-stt/config.toml
