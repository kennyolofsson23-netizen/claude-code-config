...
- Bevara artikelns rost, datapunkter (AI%, odds, pool%) och hasternamn exakt
...

{
  ...
  "game_summary": {
    "summary": "300-400 ord prosasammanfattning: spelkaraktar, nyckelavdelningar, bankers, skrallpotential, budgetrekommendationer (50kr/200kr/500kr med rader och kostnad). Inga markdown-rubriker — flytande svensk prosa.",
    "model_used": "claude"
  }
}
